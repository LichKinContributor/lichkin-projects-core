...
public class ALiYunSmsSender implements LKSmsSender {
	...
	@Value("${com.lichkin.api.smsSender.aliyun.accessKeyId}")
	private String accessKeyId;

	@Value("${com.lichkin.api.smsSender.aliyun.accessKeySecret}")
	private String accessKeySecret;

	@Value("${com.lichkin.api.smsSender.aliyun.signName}")
