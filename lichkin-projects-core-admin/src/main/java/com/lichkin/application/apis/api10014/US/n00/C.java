...
@RestController("SysEmployeeLoginCompUS00Controller")
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysEmployeeLoginComp/US")
@LKApiType(apiType = ApiType.COMPANY_BUSINESS)
public class C extends LKApiBusUpdateUsingStatusController<I, SysEmployeeLoginCompEntity> {
	...
	@Override
	protected LKApiBusUpdateUsingStatusService<I, SysEmployeeLoginCompEntity> getService(I cin) {
		return service;
	}
