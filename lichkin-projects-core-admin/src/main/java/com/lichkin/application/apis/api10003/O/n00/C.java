...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysDictionary/O")
...
public class C extends LKApiBusGetOneController<I, O, SysDictionaryEntity> {
	...
	@Override
	protected LKApiBusGetOneService<I, O, SysDictionaryEntity> getService(I cin) {
		return service;
	}
