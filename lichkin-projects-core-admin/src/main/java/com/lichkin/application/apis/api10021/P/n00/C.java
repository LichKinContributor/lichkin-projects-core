...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API + "/SysUserOperLog/P")
...
public class C extends LKApiBusGetPageController<I, O, SysUserOperLogEntity> {
	...
	@Override
	protected LKApiBusGetPageService<I, O, SysUserOperLogEntity> getService(I cin, ApiKeyValues<I> params) {
		return service;
	}
