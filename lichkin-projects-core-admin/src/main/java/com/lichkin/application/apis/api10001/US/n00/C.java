...
@RequestMapping(value = LKFrameworkStatics.WEB_MAPPING_API_WEB_ADMIN + "/SysComp/US")
@LKApiType(apiType = ApiType.COMPANY_BUSINESS)
public class C extends LKApiBusUpdateUsingStatusController<I, SysCompEntity> {
	...
	@Override
	protected LKApiBusUpdateUsingStatusService<I, SysCompEntity> getService(I cin) {
		return service;
	}
