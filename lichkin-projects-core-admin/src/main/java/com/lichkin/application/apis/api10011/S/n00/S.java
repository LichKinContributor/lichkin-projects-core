...
public class S extends LKApiBusGetListService<I, SysDeptEntity, SysDeptEntity> {
	...
	protected void initSQL(I sin, String locale, String compId, String loginId, QuerySQL sql) {
		...
		sql.eq(SysDeptR.compId, getCompId(compId, sin.getCompId()));
	...
	@Override
	protected List<SysDeptEntity> afterQuery(I sin, String locale, String compId, String loginId, List<SysDeptEntity> list) {
		if (StringUtils.isNotBlank(sin.getDeptName())) {
